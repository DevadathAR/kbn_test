        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              ...
              children: [
                peoplebgWIdget(img: mobCompanyBg),
                 Positioned(
                    bottom: 5,
                    child: SizedBox(width: size.width<240?size.width*1 -30:null ,
            ...
            Row(
              ...
              children: [
                if(size.width>240)
                Container(height: 0.5, width: size.width*.2, color: black),
                 Padding(
                  padding: EdgeInsets.symmetric(horizontal: 5),
                  child: SizedBox(width: size.width<240?size.width*1 -30:null , child: FittedBox( fit: BoxFit.scaleDown,child: Text(useMail, style: AppTextStyle.bodytext_12))),
                ),
                  if(size.width>240)
                Container(height: 0.5,  width: size.width*.2, color: black),
              ],
            ...
            Row(
              children: [
                ...
                SizedBox(width: size.width<240?size.width*1 -68:null ,child: FittedBox( fit: BoxFit.scaleDown, child: const Text("Remember me", style: AppTextStyle.bodytext_12))),
              ],
            ),
            const SizedBox(
              height: 10,
            ...
            GestureDetector(
              ...
              child: Container(
                height: 50,
                width:  size.width<120?size.width*1:
                size.width * 1 - 100,
                decoration: BoxDecoration(
                  border: Border.all(color: black),
            ...
            Wrap(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: const Text(" SignUp", style: TextStyle(color: bluee)),
                ),
