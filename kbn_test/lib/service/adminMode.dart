...
AdminApiResponse welcomeFromJson(String str) =>
    AdminApiResponse.fromJson(json.decode(str));
...
class AdminApiResponse {
  ...
  factory AdminApiResponse.fromJson(Map<String, dynamic> json) =>
      AdminApiResponse(
...
class CompaniesPageData {
  ...
  factory CompaniesPageData.fromJson(Map<String, dynamic> json) =>
      CompaniesPageData(
        approvedCompanies: List<ApprovedCompany>.from(
            json["approvedCompanies"].map((x) => ApprovedCompany.fromJson(x))),
        toBeApprovedCompanies: List<ToBeApprovedCompany>.from(
            json["toBeApprovedCompanies"]
                .map((x) => ToBeApprovedCompany.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "approvedCompanies":
            List<dynamic>.from(approvedCompanies.map((x) => x.toJson())),
        "toBeApprovedCompanies":
            List<dynamic>.from(toBeApprovedCompanies.map((x) => x.toJson())),
      };
}
...
class ToBeApprovedCompany {
  ...
  factory ToBeApprovedCompany.fromJson(Map<String, dynamic> json) =>
      ToBeApprovedCompany(
        companyId: json["companyId"],
        companyName: json["companyName"],
...
class StatisticsPageData {
  ...
  factory StatisticsPageData.fromJson(Map<String, dynamic> json) =>
      StatisticsPageData(
        performance: List<Performance>.from(
