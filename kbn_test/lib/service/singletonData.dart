...
class ApiDataService {
  ...
  CompanyApiResponse? _companyData; // Cache for company data
  AdminApiResponse? _adminData; // Cache for admin data

  bool isCompanyDataFetched = false; // To track if company data is fetched
  bool isAdminDataFetched = false; // To track if admin data is fetched
