...
CompanyApiResponse welcomeFromJson(String str) =>
    CompanyApiResponse.fromJson(json.decode(str));
...
class CompanyApiResponse {
  ...
  factory CompanyApiResponse.fromJson(Map<String, dynamic> json) =>
      CompanyApiResponse(
...
class ApplicantsPageData {
  ...
  factory ApplicantsPageData.fromJson(Map<String, dynamic> json) =>
      ApplicantsPageData(
        ...
        selected: List<Selected>.from(
            json["selected"].map((x) => Selected.fromJson(x))),
      );
...
enum Location { BRAZIL, CALICUT, KAKKANAD, KOCHI, LOCATION_KOCHI }
