...
import 'package:kbn_test/UPDATED%20UI/Widgets/statisticPagetable.dart';
...
class StatisticScreen extends StatelessWidget {
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          if (constraints.maxWidth > 1200) {
            ...
            return _buildListViewLayout(context,);
          }
        },
      ),
    );
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  SizedBox(
                    height: 500,
                    width: screenWidth * .3, // Dynamic width for RecruitmentBarChart
  ...
  Widget _buildListViewLayout(context,) {
...
Widget radialContainer(context,{
