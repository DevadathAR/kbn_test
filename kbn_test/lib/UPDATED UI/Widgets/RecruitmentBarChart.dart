...
class RecruitmentBarChart extends StatelessWidget {
  ...
  final double mobilelength;
   RecruitmentBarChart({super.key,required this.length,required this.mobilelength});
            ...
            child: BarChart(
              BarChartData(
                ...
                borderData: FlBorderData(
                  ...
                  border: const Border(
                    left:
                        BorderSide(color: Colors.black, width: 1), // Left side
                    bottom: BorderSide(
                        color: Colors.black, width: 1), // Bottom side
                  ),
                ),
